      ...
      {store ? (
        <div className="DashboardContainer">
          ...
          <div className="DataCards">
            ...
            <KPICards KPIName="Vendas" KPIData={store.daySalesCount} toolTipText="Número de vendas."></KPICards>
          ...
          <div className="DataCards">
            ...
            <KPICards KPIName="Vendas" KPIData={store.monthSalesCount} toolTipText="Número de vendas."></KPICards>
